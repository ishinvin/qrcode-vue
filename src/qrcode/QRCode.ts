...
export class QRCode {
    ...
    private makeImpl(test: boolean, maskPattern: number): void {
        ...
        const data = QRCode.createData(this.typeNumber, this.errorCorrectLevel, this.qrDataList);
    ...
    // by default, UTF8 encoding is applied.
    public static stringToBytes = stringToBytes_UTF8;
}
